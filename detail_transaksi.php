...
<html>
    ...
    <body>    
            <table class="table table-striped">
                ...
                <?php 
                    $qry_transaksi=mysqli_query($conn,"select * from transaksi join member on transaksi.id_member = member.id_member where id_transaksi = '".$_GET['id']."'");
                    $dt_transaksi=mysqli_fetch_array($qry_transaksi);
                ?>
                    <h4 style="margin-left:5px;">Nama : <?=$dt_transaksi['nama']?></h4>
                    <h6 style="float:right;"><?=$dt_transaksi['tgl_transaksi']?></h6>
                    <tr>
            ...
            <h6 style="float:right;"><?=$dt_transaksi['status_bayar']?></h6>
