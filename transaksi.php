            ...
            <div style="width:600px;float:right;">
                ...
                <table class="table table-hover striped">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?=($key_produk+1)?></td><td><?=$val_produk['jenis']?></td><td><?=$val_produk['qty']?></td><td><?=$val_produk['harga'] * $val_produk['qty']?></td><td><a href="hapus_cart.php?id=<?=$key_produk?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                        </tr>
                        <?php endforeach ?>
                        <?php } ?>
                    </tbody>
                ...
                <form action="checkout.php" class="well form-horizontal" method="post">
                    ...
                    <select name="nama" class="form-control">
                        ...
                        ?>
                        <option value="<?=$data_member['id_member']?>"><?=$data_member['nama']?></option>
                        <?php
                            }
                        ?>
                    </select>
